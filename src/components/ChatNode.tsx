            ...
            <>
                ...
                <ReactMarkdown
                    ...
                    components={{
                        ...
                        thead: ({ children, ...props }) => <thead className="bg-zinc-800" {...props}>{children}</thead>,
                        tbody: ({ children, ...props }) => <tbody className="bg-zinc-900" {...props}>{children}</tbody>,
                        tr: ({ children, ...props }) => <tr className="even:bg-zinc-800/50" {...props}>{children}</tr>,
                        th: ({ children, ...props }) => (
