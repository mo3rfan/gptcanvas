        ...
        return (
            <>
                ...
                <ReactMarkdown
                    ...
                    components={{
                        p: ({ children }) => <p className="mb-4 last:mb-0"><HighlightedText text={children} branchChildren={branchChildren} onToggleCollapse={onToggleCollapse} /></p>,
                        li: ({ children }) => <li className="mb-1"><HighlightedText text={children} branchChildren={branchChildren} onToggleCollapse={onToggleCollapse} /></li>,
                        td: ({ children }) => <td className="border border-zinc-700 px-4 py-2"><HighlightedText text={children} branchChildren={branchChildren} onToggleCollapse={onToggleCollapse} /></td>,
                        h1: ({ children }) => <h1 className="text-2xl font-bold mb-4"><HighlightedText text={children} branchChildren={branchChildren} onToggleCollapse={onToggleCollapse} /></h1>,
                        h2: ({ children }) => <h2 className="text-xl font-bold mb-3"><HighlightedText text={children} branchChildren={branchChildren} onToggleCollapse={onToggleCollapse} /></h2>,
                        h3: ({ children }) => <h3 className="text-lg font-bold mb-2"><HighlightedText text={children} branchChildren={branchChildren} onToggleCollapse={onToggleCollapse} /></h3>,
                        h4: ({ children }) => <h4 className="text-base font-bold mb-2"><HighlightedText text={children} branchChildren={branchChildren} onToggleCollapse={onToggleCollapse} /></h4>,
                        h5: ({ children }) => <h5 className="text-sm font-bold mb-1"><HighlightedText text={children} branchChildren={branchChildren} onToggleCollapse={onToggleCollapse} /></h5>,
                        h6: ({ children }) => <h6 className="text-xs font-bold mb-1"><HighlightedText text={children} branchChildren={branchChildren} onToggleCollapse={onToggleCollapse} /></h6>,
                        code({ inline, className, children, ...props }: CodeProps) {
                            ...
                            return !inline && match ? (
                                ...
                                <code className={`${className} bg-zinc-800 px-1.5 py-0.5 rounded text-blue-300 font-mono text-[13px] border border-zinc-700`} {...props}>
                                    <HighlightedText text={children} branchChildren={branchChildren} onToggleCollapse={onToggleCollapse} />
                                </code>
                            );
                        },
                    }}
